...
extends nq {
    ...
    public jb(cn cn2, double d2, double d3, double d4, double d5, double d6, double d7) {
        super(cn2, d2, d3, d4, d5, d6, d7);
        this.an = this.an * (double)0.01f + d5;
        this.ao = this.ao * (double)0.01f + d6;
        this.ap = this.ap * (double)0.01f + d7;
        d2 += (double)((this.aQ.nextFloat() - this.aQ.nextFloat()) * 0.05f);
        d3 += (double)((this.aQ.nextFloat() - this.aQ.nextFloat()) * 0.05f);
        d4 += (double)((this.aQ.nextFloat() - this.aQ.nextFloat()) * 0.05f);
        this.a = this.g;
        this.k = 1.0f;
        this.j = 1.0f;
        this.i = 1.0f;
