...
extends Panel {
    public aq(go go2) {
        ...
        go2.b.printStackTrace(new PrintWriter(stringWriter));
        ...
        try {
            ...
            string3 = string3 + "\n";
            string3 = string3 + "Minecraft: Minecraft Alpha v1.1.2_01\n";
        ...
        this.add((Component)new db(), "North");
        this.add((Component)new nb(80), "East");
        this.add((Component)new nb(80), "West");
        this.add((Component)new nb(100), "South");
