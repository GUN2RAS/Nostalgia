...
extends ex {
    ...
    public void a(ob ob2, double d2, double d3, double d4, float f2) {
        float f3;
        ly ly2 = ob2.g();
        GL11.glPushMatrix();
        float f4 = 0.6666667f;
        if (ly2 == ly.aE) {
            ...
            float f5 = (float)(ob2.f() * 360) / 16.0f;
        ...
        int n3 = 0;
        for (int i2 = 0; i2 < ob2.a.length; ++i2) {
            String string = ob2.a[i2];
            if (i2 == ob2.b) {
                string = "> " + string + " <";
                kd2.b(string, -kd2.a(string) / 2, i2 * 10 - ob2.a.length * 5, n3);
                continue;
            }
            kd2.b(string, -kd2.a(string) / 2, i2 * 10 - ob2.a.length * 5, n3);
        }
