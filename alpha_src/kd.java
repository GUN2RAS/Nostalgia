...
public class kd {
    ...
    public kd(fr fr2, String string, ey ey2) {
        int n2;
        int n3;
        int n4;
        int n5;
        ...
        for (n6 = 0; n6 < 256; ++n6) {
            ...
            float f3 = 0.0f;
            float f4 = 0.0f;
            ho2.a(0.0, 0.0f + f2, 0.0, (float)n5 / 128.0f + f3, ((float)n4 + f2) / 128.0f + f4);
            ho2.a(0.0f + f2, 0.0f + f2, 0.0, ((float)n5 + f2) / 128.0f + f3, ((float)n4 + f2) / 128.0f + f4);
            ho2.a(0.0f + f2, 0.0, 0.0, ((float)n5 + f2) / 128.0f + f3, (float)n4 / 128.0f + f4);
            ho2.a(0.0, 0.0, 0.0, (float)n5 / 128.0f + f3, (float)n4 / 128.0f + f4);
            ho2.a();
