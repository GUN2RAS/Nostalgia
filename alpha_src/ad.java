...
Runnable {
    ...
    public ad() {
        ...
        for (int i2 = 0; i2 < 64; ++i2) {
            for (int i3 = 0; i3 < 64; ++i3) {
                this.h[i2][i3] = new jj(null, i2, i3);
            }
        }
    ...
    public void b(String string) {
        this.j = 0;
        this.i = 0;
        this.d = new lk(this, new File(this.e, "saves"), string);
        this.d.e = 0;
        List list = this.g;
        synchronized (list) {
            this.g.clear();
     ...
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    private jj a(int n2, int n3) {
        int n4 = n2 & 0x3F;
        int n5 = n3 & 0x3F;
        jj jj2 = this.h[n4][n5];
        if (jj2.c == n2 && jj2.d == n3) {
            return jj2;
        }
        List list = this.g;
        synchronized (list) {
    ...
    public void a(Graphics2D graphics2D) {
        ...
        if (this.d != null) {
            graphics2D.translate(-(this.d.o + this.d.q), -(-this.d.o + this.d.q) + 64);
        }
        ...
        for (n2 = n7; n2 <= n8; ++n2) {
            for (int i2 = n5; i2 <= n6; ++i2) {
                ...
                graphics2D.drawImage((Image)jj2.a, n11, n12, null);
            }
        }
        if (this.c) {
