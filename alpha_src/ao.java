...
extends kh {
    ...
    public boolean a(double d2) {
        double d3 = this.au.b() * 4.0;
        return d2 < (d3 *= 64.0) * d3;
    }

    public ao(cn cn2, ge ge2) {
        super(cn2);
        this.g = ge2;
        this.a(0.25f, 0.25f);
        ...
        this.aB = 0.0f;
        float f2 = 0.4f;
        this.an = -eo.a(this.aq / 180.0f * (float)Math.PI) * eo.b(this.ar / 180.0f * (float)Math.PI) * f2;
        this.ap = eo.b(this.aq / 180.0f * (float)Math.PI) * eo.b(this.ar / 180.0f * (float)Math.PI) * f2;
        this.ao = -eo.a(this.ar / 180.0f * (float)Math.PI) * f2;
    ...
    public void e_() {
        ...
        block17: {
            ...
            if (this.f) {
                int n3 = this.ag.a(this.b, this.c, this.d);
                if (n3 != this.e) {
                    this.f = false;
        ...
        if (mf2 != null) {
            if (mf2.g == null || mf2.g.a(this.g, 0)) {
                // empty if block
            }
            for (n2 = 0; n2 < 8; ++n2) {
                this.ag.a("snowballpoof", this.ak, this.al, this.am, 0.0, 0.0, 0.0);
            }
            this.F();
        }
        this.ak += this.an;
        this.al += this.ao;
        this.am += this.ap;
        float f3 = eo.a(this.an * this.an + this.ap * this.ap);
        this.aq = (float)(Math.atan2(this.an, this.ap) * 180.0 / 3.1415927410125732);
        this.ar = (float)(Math.atan2(this.ao, f3) * 180.0 / 3.1415927410125732);
        ...
        if (this.g_()) {
            for (int i2 = 0; i2 < 4; ++i2) {
                float f5 = 0.25f;
                this.ag.a("bubble", this.ak - this.an * (double)f5, this.al - this.ao * (double)f5, this.am - this.ap * (double)f5, this.an, this.ao, this.ap);
            }
            f4 = 0.8f;
        }
        this.an *= (double)f4;
