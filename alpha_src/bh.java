...
extends lm {
    ...
    protected void a(int n2, int n3, int n4) {
        if (n4 == 0) {
            for (int i2 = 0; i2 < this.e.size(); ++i2) {
                fk fk2 = (fk)this.e.get(i2);
                if (!fk2.c(this.b, n2, n3)) continue;
                this.a = fk2;
    ...
    public void b(int n2) {
        ...
        ho ho2 = ho.a;
        GL11.glBindTexture((int)3553, (int)this.b.n.a("/dirt.png"));
        GL11.glColor4f((float)1.0f, (float)1.0f, (float)1.0f, (float)1.0f);
        float f2 = 32.0f;
        ho2.b();
        ho2.b(0x404040);
        ho2.a(0.0, this.d, 0.0, 0.0, (float)this.d / f2 + (float)n2);
        ho2.a(this.c, this.d, 0.0, (float)this.c / f2, (float)this.d / f2 + (float)n2);
        ho2.a(this.c, 0.0, 0.0, (float)this.c / f2, 0 + n2);
        ho2.a(0.0, 0.0, 0.0, 0.0, 0 + n2);
        ho2.a();
    }
