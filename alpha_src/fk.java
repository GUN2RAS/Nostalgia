...
extends lm {
    ...
    public fk(int n2, int n3, int n4, String string) {
        this(n2, n3, n4, 200, 20, string);
    }

    protected fk(int n2, int n3, int n4, int n5, int n6, String string) {
        this.f = n2;
        this.c = n3;
        this.d = n4;
        this.a = n5;
    ...
    public void a(Minecraft minecraft, int n2, int n3) {
        ...
        kd kd2 = minecraft.o;
        GL11.glBindTexture((int)3553, (int)minecraft.n.a("/gui/gui.png"));
        ...
        if (!this.g) {
            this.a(kd2, this.e, this.c + this.a / 2, this.d + (this.b - 8) / 2, -6250336);
        } else if (bl2) {
            this.a(kd2, this.e, this.c + this.a / 2, this.d + (this.b - 8) / 2, 0xFFFFA0);
        } else {
            this.a(kd2, this.e, this.c + this.a / 2, this.d + (this.b - 8) / 2, 0xE0E0E0);
        }
    }
