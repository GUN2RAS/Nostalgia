  ...
  public static void drawHUD(GuiGraphicsExtractor graphics, DeltaTracker tracker) {
    if (overlayActive) {
      ...
      if (!mc.options.hideGui && mc.screen == null) {
        ...
        int ty = y + 8;
        graphics.text(font, "\u00a7b\u00a7lSHA PERFORMANCE PROFILER", x + 12, ty, -16711681, false);
        ty += 12;
        ...
        ty += 12;
        graphics.text(font, "\u00a7fRAM cache: \u00a7d" + String.format(Locale.US, "%.2f MB", totalRAM), x + 12, ty, -1, false);
        ty += 12;
        graphics.text(font, "\u00a7fCached chunks: \u00a7e" + alphaChunks + " \u00a77(Alpha)", x + 12, ty, -1, false);
        ty += 12;
        graphics.text(font, "\u00a7fCached sections: \u00a7e" + totalSections + " \u00a77(Other)", x + 12, ty, -1, false);
        ty += 12;
        graphics.text(font, "\u00a7fOverrides: \u00a7e" + totalOverrides + " \u00a77(Deltas)", x + 12, ty, -1, false);
        ty += 12;
        ...
        graphics.fill(x + 10, ty, x + w - 10, ty + 1, 637534207);
        ty += 6;
        graphics.text(font, "\u00a7b\u00a7lDISK CACHE SYSTEM:", x + 12, ty, -16711681, false);
        ty += 12;
        String readText = lastDiskReadTimeMs > 0L
          ? String.format(Locale.US, "\u00a7a%d ms \u00a77(%.2f MB)", lastDiskReadTimeMs, lastDiskReadSizeMB)
          : "\u00a77None";
        graphics.text(font, "\u00a7fLast Load: " + readText, x + 12, ty, -1, false);
        ty += 12;
        String writeText = lastDiskWriteTimeMs > 0L
          ? String.format(Locale.US, "\u00a7a%d ms \u00a77(%.2f MB)", lastDiskWriteTimeMs, lastDiskWriteSizeMB)
          : "\u00a77None";
        graphics.text(font, "\u00a7fLast Save: " + writeText, x + 12, ty, -1, false);
        ty += 12;
        ty += 6;
        graphics.text(font, "\u00a77Latency Timeline (last 50 frames)", x + 12, ty, -5592406, false);
        ty += 12;
        int graphH = 45;
        int graphY = ty;
        ...
        graphics.fill(x + 10, ty, x + w - 10, ty + 1, 637534207);
        ty += 6;
        graphics.text(font, "\u00a7b\u00a7lLAST HOLOGRAM EVENT:", x + 12, ty, -16711681, false);
        ty += 12;
        ...
        graphics.text(font, "\u00a7e" + lastEvent, x + 12, ty, -1, false);
      }
    }
  }
