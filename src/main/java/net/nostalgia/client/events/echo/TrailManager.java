...
public class TrailManager {
    ...
    public static void tick(Iterable<? extends Player> players) {
        ...
        for (Player player : players) {
            ...
            net.nostalgia.alphalogic.ritual.TimestopZoneManager.ActiveZone zone = net.nostalgia.alphalogic.ritual.TimestopZoneManager.findZoneContaining(player.level().dimension(), player.blockPosition());
