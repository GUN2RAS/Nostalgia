...
public final class MonolithicClientEchoRitualView implements ClientEchoRitualView {
  ...
  public boolean isTransitioning() {
    return RitualVisualManager.isTransitioning;
  }

  @Override
  public boolean isBystander() {
    return RitualVisualManager.isBystander;
  }

  @Override
  public int currentPhase() {
    return RitualVisualManager.currentPhase;
  }

  @Override
  public BlockPos ritualCenter() {
    return RitualVisualManager.ritualCenter;
  }

  @Override
  public String targetDimension() {
    return RitualVisualManager.targetDimension;
  }
  ...
  @Override
  public boolean isInNewDimension() {
    return RitualVisualManager.isInNewDimension();
  }

  @Override
  public boolean waitingForChunks() {
    return RitualVisualManager.waitingForChunks;
  }

  @Override
  public int lastReportedSurfaceY() {
    return RitualVisualManager.lastReportedSurfaceY;
  }

  @Override
  public long visualTime() {
    return RitualVisualManager.getVisualTime();
  }

  @Override
  public long phase2StartTime() {
    return RitualVisualManager.phase2StartTime;
  }

  @Override
  public long phase3StartTime() {
    return RitualVisualManager.phase3StartTime;
  }

  @Override
  public long transitionStartTime() {
    return RitualVisualManager.transitionStartTime;
  }

  @Override
  public float alphaRadius() {
    return RitualVisualManager.getTransitionAlphaRadius();
  }

  @Override
  public float whiteoutAlpha() {
    return RitualVisualManager.getWhiteoutAlpha();
  }

  @Override
  public float whiteRadius() {
    return RitualVisualManager.getWhiteRadius();
  }

  @Override
  public float fadeProgress() {
    return RitualVisualManager.getFadeProgress();
  }

  @Override
  public float transitionTimeSeconds() {
    return RitualVisualManager.getTransitionTimeSeconds();
  }
}
