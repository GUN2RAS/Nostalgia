...
public class RitualSoundManager {
    ...
    public static void tick(Player player) {
        ...
        net.nostalgia.alphalogic.ritual.TimestopZoneManager.ActiveZone currentZone = net.nostalgia.alphalogic.ritual.TimestopZoneManager.findZoneContaining(player.level().dimension(), player.blockPosition());
