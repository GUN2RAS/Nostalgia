...
public class AlphaHologramProvider implements DimensionHologramProvider {
    ...
    public BlockState getBlockState(byte id, boolean isSkyInverted) {
        ...
        if (id == 2) return net.nostalgia.block.AlphaBlocks.ALPHA_GRASS_BLOCK.defaultBlockState();
        ...
        if (id == 37) return net.nostalgia.block.AlphaBlocks.ALPHA_YELLOW_FLOWER.defaultBlockState();
        if (id == 38) return net.nostalgia.block.AlphaBlocks.ALPHA_RED_FLOWER.defaultBlockState();
        ...
        if (id == 81) return net.nostalgia.block.AlphaBlocks.ALPHA_CACTUS.defaultBlockState();
        if (id == 82) return net.nostalgia.block.AlphaBlocks.ALPHA_CLAY.defaultBlockState();
        if (id == 83) return net.nostalgia.block.AlphaBlocks.ALPHA_SUGAR_CANE.defaultBlockState();
