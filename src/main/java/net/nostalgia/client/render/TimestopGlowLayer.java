...
public class TimestopGlowLayer extends RenderLayer<AvatarRenderState, PlayerModel> {
    ...
    public void submit(PoseStack poseStack, SubmitNodeCollector submitNodeCollector, int lightCoords, AvatarRenderState state, float yRot, float xRot) {
        ...
        net.nostalgia.alphalogic.ritual.TimestopZoneManager.ActiveZone zone = net.nostalgia.alphalogic.ritual.TimestopZoneManager.findZoneContaining(entity.level().dimension(), entity.blockPosition());
        if (zone != null) {
            ...
            java.util.LinkedList<net.nostalgia.client.events.echo.TrailManager.TrailSnapshot> trail = net.nostalgia.client.events.echo.TrailManager.TRAILS.get(entity.getUUID());
            if (trail != null && !trail.isEmpty()) {
                for (net.nostalgia.client.events.echo.TrailManager.TrailSnapshot ghost : trail) {
                    poseStack.pushPose();
