...
public class AlphaVec3D {
  ...
  public AlphaVec3D normalize() {
    ...
    return len < 1.0E-4 ? create(0.0, 0.0, 0.0) : create(this.x / len, this.y / len, this.z / len);
  }
  ...
  public void rotateAroundX(float angle) {
    ...
    double d2 = this.x;
    double d3 = this.y * f3 + this.z * f4;
    double d4 = this.z * f3 - this.y * f4;
    this.x = d2;
    this.y = d3;
    this.z = d4;
  }
  ...
  public void rotateAroundY(float angle) {
    float f3 = AlphaMathHelper.cos(angle);
    float f4 = AlphaMathHelper.sin(angle);
    double d2 = this.x * f3 + this.z * f4;
    double d3 = this.y;
    double d4 = this.z * f3 - this.x * f4;
    this.x = d2;
    this.y = d3;
    this.z = d4;
  }
