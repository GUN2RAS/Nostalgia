...
public class AlphaSounds {
  ...
  public static final SoundType ALPHA_GRASS = new SoundType(
    1.0F,
    1.0F,
    (SoundEvent)STEP_GRASS.value(),
    (SoundEvent)STEP_GRASS.value(),
    (SoundEvent)STEP_GRASS.value(),
    (SoundEvent)STEP_GRASS.value(),
    (SoundEvent)STEP_GRASS.value()
  );
  public static final SoundType ALPHA_STONE = new SoundType(
    1.0F,
    1.0F,
    (SoundEvent)STEP_STONE.value(),
    (SoundEvent)STEP_STONE.value(),
    (SoundEvent)STEP_STONE.value(),
    (SoundEvent)STEP_STONE.value(),
    (SoundEvent)STEP_STONE.value()
  );
  public static final SoundType ALPHA_WOOD = new SoundType(
    1.0F,
    1.0F,
    (SoundEvent)STEP_WOOD.value(),
    (SoundEvent)STEP_WOOD.value(),
    (SoundEvent)STEP_WOOD.value(),
    (SoundEvent)STEP_WOOD.value(),
    (SoundEvent)STEP_WOOD.value()
  );
  public static final SoundType ALPHA_GRAVEL = new SoundType(
    1.0F,
    1.0F,
    (SoundEvent)STEP_GRAVEL.value(),
    (SoundEvent)STEP_GRAVEL.value(),
    (SoundEvent)STEP_GRAVEL.value(),
    (SoundEvent)STEP_GRAVEL.value(),
    (SoundEvent)STEP_GRAVEL.value()
  );
  public static final SoundType ALPHA_SAND = new SoundType(
    1.0F,
    1.0F,
    (SoundEvent)STEP_SAND.value(),
    (SoundEvent)STEP_SAND.value(),
    (SoundEvent)STEP_SAND.value(),
    (SoundEvent)STEP_SAND.value(),
    (SoundEvent)STEP_SAND.value()
  );
  public static final SoundType ALPHA_CLOTH = new SoundType(
    1.0F,
    1.0F,
    (SoundEvent)STEP_CLOTH.value(),
    (SoundEvent)STEP_CLOTH.value(),
    (SoundEvent)STEP_CLOTH.value(),
    (SoundEvent)STEP_CLOTH.value(),
    (SoundEvent)STEP_CLOTH.value()
  ...
  private static Holder<SoundEvent> register(String name) {
    Identifier id = Identifier.fromNamespaceAndPath("nostalgia", name);
