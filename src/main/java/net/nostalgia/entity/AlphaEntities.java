...
public class AlphaEntities {
    ...
    public static final EntityType<ThrownAmethystEntity> THROWN_AMETHYST = register(
            "thrown_amethyst",
            EntityType.Builder.<ThrownAmethystEntity>of(ThrownAmethystEntity::new, MobCategory.MISC)
                    .sized(0.25F, 0.25F)
